...
crop.freq <- brick('/home/shared/Kane_data/CropScape/crop_frequency_wheat_2008-2022.tif')
...
saveRDS(gssurgo.soil.ratio, file = "/home/aysha/Kane_data/wheat/gssurgo.wheat.soil.filter_noNA_ratios.rds")

#----------combine soil data and ratio------------------#

soil_data <- readRDS('/home/aysha/Kane_data/wheat/wheat_gssurgo.soil.stats_filter_om10.rds')
soil_ratio <- readRDS('/home/aysha/Kane_data/wheat/gssurgo.wheat.soil.filter_noNA_ratios.rds')
...
saveRDS(soil_data.1, file = '/home/aysha/Kane_data/wheat/wheat1_gssurgo.soil.stats_n_15_filter_om10.rds')
