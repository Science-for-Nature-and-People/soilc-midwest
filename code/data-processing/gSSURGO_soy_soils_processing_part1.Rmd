...
nass_soy <- readRDS("/home/aysha/Kane_data/soy_yield_2000-2022_w_irrigation_n_15.rds")
...
fips_codes <- fips_codes %>%
  ...
  filter(GEOID %in% unique(nass_soy$GEOID)) %>%  ## ML: used the new 2000-2022 data file
...
write_rds(all_states_gssurgo, 
        file = paste0("/home/aysha/Kane_data/all_states_gssurgo/all_states_gssurgo_soy_n_15_part",n,".rds"))
...
all_states_gssurgo <- readRDS(
  paste0("~/Kane_data/all_states_gssurgo/all_states_gssurgo_soy_n_15_part",i,".rds"))
...
write_rds(all_counties_gssurgo, 
          file = paste0("~/Kane_data/all_counties_gssurgo/all_counties_gssurgo_soy_part",i,".rds"))
...
all_counties_gssurgo <- read_rds(file = paste0("/home/aysha/Kane_data/all_counties_gssurgo/all_counties_gssurgo_soy_part",i,".rds"))
