---
title: "Soy merge yield and soil data"
author: "ATR"
date: "2023-07-20"
output: html_document
---

# copied from corn_all_data_merge-AFT.Rmd
...
```{r data}
# Yield data
yield <- read_rds('c:/Users/AyshaTappRoss/Github/soilc-midwest-DanKane/data/AFT-data/soy_yield_2000-2022_w_irrigation_n_15.rds')

#gssurgo soil data
soil <- read_rds('c:/Users/AyshaTappRoss/Github/soilc-midwest-DanKane/data/AFT-data/soy_gssurgo.soil.stats_n_15_filter_om10.rds')
...
saveRDS(all_data.1, "c:/Users/AyshaTappRoss/Github/soilc-midwest-DanKane/data/AFT-data/soy_all_data_n15_om10_AFT.rds")
...
```{r check}
all_data <- read_rds('c:/Users/AyshaTappRoss/Github/soilc-midwest-DanKane/data/AFT-data/soy_all_data_n15_om10_AFT.rds')
