...
nass_15 <- readRDS("/home/aysha/Kane_data/soy/soy_yield_2000-2022_w_irrigation_n_15.rds")
...
fips_codes <- fips_codes %>%
  ...
  mutate(county = str_remove(county, " County")) # ML: 1640 observations
...
sa_subset <- sa_catalogs %>%
  ...
  rename("state" = state.x) # ML: 1638 observations
...
write_rds(all_states_gssurgo, 
        file = paste0("/home/aysha/Kane_data/all_states_gssurgo/all_states_gssurgo_n_15_part",n,".rds"))
...
all_states_gssurgo <- readRDS(
  paste0("/home/aysha/Kane_data/all_states_gssurgo/all_states_gssurgo_soy_n_15_part",i,".rds"))
...
write_rds(all_counties_gssurgo, 
          file = paste0("/home/aysha/Kane_data/all_counties_gssurgo/all_counties_gssurgo_part",i,".rds"))
...
all_counties_gssurgo <- read_rds(file = paste0("/home/aysha/Kane_data/all_counties_gssurgo/all_counties_gssurgo_part",i,".rds"))
...
mclapply(mc.cores = 4, unique(all_counties_gssurgo$GEOID), FUN = function(x){
  write_rds(all_counties_gssurgo[all_counties_gssurgo$GEOID == x,], 
            file = paste("/home/aysha/Kane_data/county_gssurgo_gdbs/GEOID_", x, ".rds", sep = ""))
})
