...
saveRDS(gssurgo.soil.ratio, file = "~/Documents/Kane_data/gssurgo.soil.filter_noNA_ratios.rds")

#----------combine soil data and ratio------------------#

soil_data <- readRDS('~/Documents/Kane_data/gssurgo.soil.stats_filter_om10.rds')
soil_ratio <- readRDS('~/Documents/Kane_data/gssurgo.soil.filter_noNA_ratios.rds')
...
saveRDS(soil_data.1, file = '~/Documents/Kane_data/gssurgo.soil.stats_n_15_filter_om10.rds')
