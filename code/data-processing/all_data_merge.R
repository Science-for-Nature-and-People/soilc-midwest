...
all_data$RMA.drought.Liability..US..[is.na(all_data$RMA.drought.Liability..US..)] <- 0
all_data$RMA.precip.Liability..US..[is.na(all_data$RMA.precip.Liability..US..)] <- 0
all_data$RMA.drought.Subsidy..US..[is.na(all_data$RMA.drought.Subsidy..US..)] <- 0
all_data$RMA.precip.Subsidy..US..[is.na(all_data$RMA.precip.Subsidy..US..)] <- 0
all_data$loss_cost[is.na(all_data$loss_cost)] <- 0
...
saveRDS(all_data, "data/all_data_2020.03.02.rds")
